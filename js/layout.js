...
$(document).ready(function() {
     ...
     $(".artmidSubNavclose").click(function() {
          artmidhide();
          $(".artmidSubNav").hide();
        })
     
     
     $(".secimgA").click(function() {
            artmidhide();
            $("#artmidSubNav01").toggle(500);
        })
     $(".secimgB").click(function() {
            artmidhide();
            $("#artmidSubNav02").toggle(500);
        })
      $(".secimgC").click(function() {
            artmidhide();
            $("#artmidSubNav03").toggle(500);
        })
       $(".secimgD").click(function() {
            artmidhide();
            $("#artmidSubNav04").toggle(500);
        })
   ...
   {
     $(".artmidSubNav").show();
     $("#artmidSubNav01").hide(0);
     $("#artmidSubNav02").hide(0);
     $("#artmidSubNav03").hide(0);
     $("#artmidSubNav04").hide(0);
   }
